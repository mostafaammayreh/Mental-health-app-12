...
import 'package:untitled/QuizPage.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              InkWell(
                child: ListTile(
                  title: const Center(child: Text('Depression', style: style)),
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => QuizPage(
                              ...
                              8,
                              'Depression',
                              const [Colors.blue, Colors.greenAccent])));
                },
              ),
              SizedBox(height: height / 60),
              InkWell(
                child: ListTile(
                  title: const Center(child: Text('Anxiety', style: style)),
                  tileColor: Colors.grey[100],
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(15),
                    side: const BorderSide(color: Colors.black, width: 1),
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => QuizPage(
                              ...
                              7,
                              'Anxiety and stress',
                              const [Colors.red, Colors.pinkAccent])));
                },
              ),
              SizedBox(height: height / 60),
              InkWell(
                child: ListTile(
                  title: const Center(child: Text('PTSD', style: style)),
                  tileColor: Colors.grey[100],
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(15),
                    side: const BorderSide(color: Colors.black, width: 1),
                ...
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => QuizPage(pstd, 5, 'PTSD',
                              const [Colors.cyan, Colors.teal])));
                },
              ),
              SizedBox(height: height / 60),
              InkWell(
                child: ListTile(
                  title:
                      const Center(child: Text('Schizophrenia', style: style)),
                  tileColor: Colors.grey[100],
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(15),
                    side: const BorderSide(color: Colors.black, width: 1),
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => QuizPage(
                              ...
                              8,
                              'Schizophrenia',
                              const [Colors.purple, Colors.indigo])));
                },
              ),
              SizedBox(height: height / 60),
              InkWell(
                child: ListTile(
                  title: const Center(child: Text('Addiction', style: style)),
                  tileColor: Colors.grey[100],
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(15),
                    side: const BorderSide(color: Colors.black, width: 1),
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => QuizPage(
                              ...
                              6,
                              'Addiction',
                              const [Colors.brown, Colors.blueGrey])));
                },
              ),
              SizedBox(height: height / 60),
            ],
